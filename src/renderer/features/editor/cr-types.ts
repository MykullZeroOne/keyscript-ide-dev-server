/**
 * Full CR Framework + ExtJS 3 type declarations for Monaco IntelliSense.
 * Generated from keyscript-all.js API surface analysis.
 */

export const CR_FRAMEWORK_TYPES = `
// ═══════════════════════════════════════════════════════════════
